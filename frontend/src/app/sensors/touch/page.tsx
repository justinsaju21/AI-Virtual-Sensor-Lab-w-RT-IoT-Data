        ...
        <>
            ...
            >
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    ...
                    <Card variant="default" className="md:col-span-2"><CardHeader><CardTitle>Status</CardTitle></CardHeader><CardContent><div className="mt-4"><LiveChart data={history} color="#14b8a6" gradientId="touchGrad" unit="" height={220} minDomain={-0.1} maxDomain={1.1} type="stepAfter" /></div></CardContent></Card>
                </div>
                <div className="flex justify-center mt-4 mb-4">
                    <button onClick={() => setShowQuiz(true)} className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-teal-500/20 to-emerald-500/20 border border-teal-500/30 rounded-xl text-white font-medium hover:from-teal-500/30 hover:to-emerald-500/30 transition">
                        <Brain className="h-5 w-5 text-teal-400" /> Test Knowledge</button>
                </div>
