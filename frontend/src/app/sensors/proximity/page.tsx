        ...
        <>
            ...
            >
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    ...
                    <Card variant="default" className="md:col-span-2"><CardHeader><CardTitle>Status</CardTitle></CardHeader><CardContent><div className="mt-4"><LiveChart data={history} color="#06b6d4" gradientId="proximityGrad" unit="" height={220} minDomain={-0.1} maxDomain={1.1} type="stepAfter" /></div></CardContent></Card>
                </div>
                <div className="flex justify-center mt-4 mb-4">
                    <button onClick={() => setShowQuiz(true)} className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-lime-500/20 to-green-500/20 border border-lime-500/30 rounded-xl text-white font-medium hover:from-lime-500/30 hover:to-green-500/30 transition">
                        <Brain className="h-5 w-5 text-lime-400" /> Test Knowledge</button>
                </div>
